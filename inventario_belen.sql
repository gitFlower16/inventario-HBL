...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2024 a las 19:50:21
...
--
-- Base de datos: `inventario_belen`
--
...
(121, 'Recursos Humanos', 'Antonio Mendez'),
(122, 'Tesorería', 'Mari Gaby Santillán'),
(123, 'Logística', 'Jhon Damian'),
...
('10080500-05', 'TOSHIBA', 'Satellite', '8E086082S', 'Windows 8', '3453453', 'Core I5', '2GB', 'HDD 1 TB', 117, 'MALO'),
('11180500-01', 'TOSHIBA', 'Victus', '', 'Windows 11', '', 'Core I9', '16GB', '', 124, 'BUENO'),
('20081500-01', 'LENOVO', 'Idea Pad', 'SDF435K', 'Windows 7', '', 'Core i7', '4GB', 'HD 1Tb', 120, 'BUENO'),
...
CREATE TABLE `desplazamiento` (
  ...
  `tipo_bien` enum('COMPUTADORAS','IMPRESORAS','SWITCHES','PERIFERICOS','SCANNERS','SERVIDORES') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `desplazamiento` (`id`, `motivo`, `tipo_bien`, `marca`, `modelo`, `serie`, `cod_patrimonial`, `area_prov`, `responsable_prov`, `area_asig`, `responsable_asig`, `fecha`) VALUES
(8, 'Desplazamiento', 'IMPRESORAS', 'Epson', 'Epson HTJ', 'EPSON HTJ', '74222358-02', 'Administración', 'Cheril de Lima', 'Recursos Humanos', 'Antonio Mendez', '2024-01-24'),
(17, 'Desplazamiento', 'COMPUTADORAS', 'LENOVO', 'Idea Pad', 'IDEA PAD', '24081500-04', 'Administración', 'Cheril de Lima', 'Estadística', 'Juan Armando', '2024-01-15');
...
INSERT INTO `usuario` (`id`, `nombres`, `email`, `pass_hash`, `rol`, `estado`) VALUES
(1, 'Maria Santillan', 'mari.cabsantillan@gmail.com', '$2y$12$iUC33/x.ffMEX7iyR9Ku/u03uU5uquKLecsy0v47l42UTZMfFn77G', 'ADMINISTRADOR', 'ACTIVO'),
(3, 'Jhon Damian Flores', 'flores20@gmail.com', '$2y$12$iUC33/x.ffMEX7iyR9Ku/u03uU5uquKLecsy0v47l42UTZMfFn77G', 'INFORMATICO', 'ACTIVO'),
(10, 'Gabrielita Lima', 'fresita_santillan@gmail.com', '$2y$12$Clb11ztE7mqbiA/KgyL/7.682f.NlKg1LPPYqKJE4wZimKO7dkjnO', 'INFORMATICO', 'INACTIVO');
