...
<head>
  ...
  <title>LOGIN | BELEN INFORMATICS</title>
...
<div class="container" id="loginForm">
    <form onsubmit="event.preventDefault(); Login();" class="form">
        ...
        <!--<input type="password" class="input" placeholder="Ingrese su contraseña" id="txtPass" autocomplete="off" required>
        <div class="view">
            <i class="fas fa-eye verPassword" onclick="vista()" id="verPassword" style="color:grey;"></i>
        </div>-->
...
<script>
    ...
    //Este cambio lo hice yo Jhon 
    //Cambio realizado por Gabriela Santillán
    /*function mostrarFormulario(tipo) {
        if (tipo === 'login') {
            document.getElementById('loginForm').style.display = 'flex'; // Cambiar a 'flex'
            document.getElementById('RecuperarForm').style.display = 'none';
            document.getElementById('sideLogin').style.display = 'block'; // Mostrar el lado del video
            document.getElementById('sideRecuperar').style.display = 'none';
        } else if (tipo === 'recuperar') {
            document.getElementById('loginForm').style.display = 'none';
            document.getElementById('RecuperarForm').style.display = 'flex'; // Cambiar a 'flex'
            document.getElementById('sideLogin').style.display = 'none';
            document.getElementById('sideRecuperar').style.display = 'block'; // Mostrar el lado del video
        }
    }*/
    function mostrarFormulario(tipo) {
    if (tipo === 'login') {
